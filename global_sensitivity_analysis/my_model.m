...
if delta_start >=0 % If RT starts before
 ...
 QT_treat = [treat_start+delta_start, treat_start+delta_start+delta_TMZ, treat_start+delta_start+2*delta_TMZ];
 QT_treat = [QT_treat, QT_treat+0.2, QT_treat+0.4]; QT_treat = sort(QT_treat);
 ...
 QT_treat = [treat_start, treat_start+delta_TMZ, treat_start+2*delta_TMZ];
 QT_treat = [QT_treat, QT_treat+0.2, QT_treat+0.4]; QT_treat = sort(QT_treat);
end
...
% Solve ODEs
[t,pops] = simul_combined_CRT(p_in,param,RT_treat,QT_treat,t_after_treat);
