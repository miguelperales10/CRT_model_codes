...
if num_treatment == tto_control
    ...
    QT_tto=[1,1.2,1.4,2,2.2,2.4,3,3.2,3.4];  % first row: days - NO RT
           % 3,3,3];  % second row: number of dosis
    RT_tto=199;
    t_despues_tto =  200;
    
    elseif num_treatment == tto_TMZ_X4
    QT_tto=[1,1.2,1.4,5,5.2,5.4,9,9.2,9.4];  % first row: days - NO RT
            %3,3,3];  % second row: number of dosis
    RT_tto=199;
    t_despues_tto =  200;
        
    elseif num_treatment == tto_TMZ_X7
    QT_tto=[1,1.2,1.4,8,8.2,8.4,15,15.2,15.4];  % first row: days - NO RT
            %3,3,3];  % second row: number of dosis
    RT_tto= 199;
    t_despues_tto =  200;

    elseif num_treatment == tto_TMZ_X13
    QT_tto=[1,1.2,1.4,14,14.2,14.4,27,27.2,27.4];  % first row: days - NO RT
            %3,3,3];  % second row: number of dosis
    RT_tto= 199;
    t_despues_tto =  200;
